...
import logging
import os
from sklearn.preprocessing import RobustScaler  # 导入RobustScaler用于Robust标准化
...
class TextDataset(Dataset):
    def __init__(self, tokenizer, args, file_path=None, mode='train', buggy_lines_file_path=None):
        ...
        # 使用RobustScaler进行Robust标准化
        robust_scaler = RobustScaler(quantile_range=(10.0, 90.0))
        manual_features = robust_scaler.fit_transform(features_data[manual_features_columns].to_numpy())
